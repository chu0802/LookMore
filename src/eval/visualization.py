...
if __name__ == "__main__":
    main(argument_parser(
        ...
        Arg("--maps_dir", type=Path, default=Path("/home/yuchuyu/project/lookwhere/output/mae_prediction/validation")),
        Arg("--output_dir", type=Path, default=Path("output/vis/validation/mae_prediction")),
